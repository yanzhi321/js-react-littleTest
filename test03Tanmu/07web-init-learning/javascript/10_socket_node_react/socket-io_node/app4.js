...
io.on('connection', function(socket) {
    ...
    //touch
    socket.on('box touchFir', function(data) {
        console.log(data)
        io.sockets.emit('touchFir send', data)
    })

    socket.on('box touchSec', function(data) {
        io.sockets.emit('touchSec send', data)
    })

    socket.on('box touchThird', function(data) {
        io.sockets.emit('touchThird send', data)
    })
